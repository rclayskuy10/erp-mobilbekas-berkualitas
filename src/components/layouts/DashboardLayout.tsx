...
const menuItems = [
  ...
  { name: 'Customer', href: '/dashboard/customers', icon: User, module: 'customers' },
  { name: 'Vendor', href: '/dashboard/vendors', icon: Building2, module: 'vendors' },
  { name: 'Analytics', href: '/dashboard/analytics', icon: LineChart, module: 'analytics' },
