...
import { formatCurrency, getMonthName, calculateFinancialMetrics } from '@/lib/utils';
import {
  Car,
  ShoppingCart,
  TrendingUp,
...
function DashboardContent() {
  ...
  // Calculate financial stats using centralized function
  const { totalRevenue, totalHPP, grossProfit, totalExpenses, netProfit } = calculateFinancialMetrics(cars, sales, expenses);
