...
import { cars as initialCars, vendors, grns } from '@/data/dummy';
import {
  formatCurrency,
  formatNumber,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
            {filteredCars.map((car) => {
              ...
              if (grn) {
                ...
                stockAgeDays = Math.floor((today.getTime() - purchaseDate.getTime()) / (1000 * 60 * 60 * 24));
              }
              const isOldStock = stockAgeDays > 30;
              ...
              >
                ...
                <div className="relative h-32 md:h-48">
                  ...
                  <div className="absolute top-2 right-2 flex flex-col gap-1 items-end">
                    ...
                    {car.status === 'available' && stockAgeDays > 0 && (
                      <Badge variant={isOldStock ? 'danger' : 'default'}>
                        {stockAgeDays} Hari
                      </Badge>
                    )}
                  </div>
